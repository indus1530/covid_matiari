...
import edu.aku.hassannaqvi.covid_matiari.databinding.ActivitySectionPicBinding;
...
public class SectionPICActivity extends AppCompatActivity {
    ...
    public void BtnContinue() {
        ...
        if (UpdateDB()) {
            finish();
            startActivity(new Intent(this, MainApp.personal.getHhModel().getMemAge() < 5 ? SectionIM1Activity.class : PIEndingActivity.class).putExtra("complete", true));
        } else {
