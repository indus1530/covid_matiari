package edu.aku.hassannaqvi.covid_matiari.ui.other;
...
import edu.aku.hassannaqvi.covid_matiari.CONSTANTS;
import edu.aku.hassannaqvi.covid_matiari.R;
import edu.aku.hassannaqvi.covid_matiari.core.AppInfo;
import edu.aku.hassannaqvi.covid_matiari.core.DatabaseHelper;
import edu.aku.hassannaqvi.covid_matiari.core.MainApp;
import edu.aku.hassannaqvi.covid_matiari.databinding.ActivityLoginBinding;

import static edu.aku.hassannaqvi.covid_matiari.CONSTANTS.MINIMUM_DISTANCE_CHANGE_FOR_UPDATES;
import static edu.aku.hassannaqvi.covid_matiari.CONSTANTS.MINIMUM_TIME_BETWEEN_UPDATES;
import static edu.aku.hassannaqvi.covid_matiari.CONSTANTS.MY_PERMISSIONS_REQUEST_READ_CONTACTS;
import static edu.aku.hassannaqvi.covid_matiari.CONSTANTS.MY_PERMISSIONS_REQUEST_READ_PHONE_STATE;
import static edu.aku.hassannaqvi.covid_matiari.CONSTANTS.TWO_MINUTES;
import static edu.aku.hassannaqvi.covid_matiari.data.UserDataKt.userTestData;
import static edu.aku.hassannaqvi.covid_matiari.utils.app_utils.AppUtilsKt.getPermissionsList;
import static edu.aku.hassannaqvi.covid_matiari.utils.db_utils.CreateTable.DATABASE_NAME;
import static edu.aku.hassannaqvi.covid_matiari.utils.db_utils.CreateTable.DB_NAME;
import static edu.aku.hassannaqvi.covid_matiari.utils.db_utils.CreateTable.PROJECT_NAME;
