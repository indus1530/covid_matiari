package edu.aku.hassannaqvi.covid_matiari.sync;
...
import edu.aku.hassannaqvi.covid_matiari.contracts.RandomContract;
import edu.aku.hassannaqvi.covid_matiari.contracts.UsersContract;
...
//                    pd.show();
                    ...
                    list.get(position).setstatus("Server Error");
