...
import edu.aku.hassannaqvi.covid_matiari.core.AndroidDatabaseManager;
import edu.aku.hassannaqvi.covid_matiari.core.MainApp;
import edu.aku.hassannaqvi.covid_matiari.databinding.ActivityMainBinding;
import edu.aku.hassannaqvi.covid_matiari.models.Form;
import edu.aku.hassannaqvi.covid_matiari.models.VersionApp;
import edu.aku.hassannaqvi.covid_matiari.ui.list_activity.FormsReportCluster;
...
import edu.aku.hassannaqvi.covid_matiari.ui.sections.SectionH5Activity;
import edu.aku.hassannaqvi.covid_matiari.ui.sections.SectionIM1Activity;
import edu.aku.hassannaqvi.covid_matiari.ui.sections.SectionIM2Activity;
import edu.aku.hassannaqvi.covid_matiari.ui.sections.SectionIM3Activity;
...
import edu.aku.hassannaqvi.covid_matiari.utils.app_utils.AndroidUtilityKt;
import edu.aku.hassannaqvi.covid_matiari.utils.app_utils.AppUtilsKt;
import edu.aku.hassannaqvi.covid_matiari.utils.app_utils.WarningActivityInterface;
import edu.aku.hassannaqvi.covid_matiari.utils.db_utils.CreateTable;

import static edu.aku.hassannaqvi.covid_matiari.core.MainApp.appInfo;
    ...
    public void openSpecificActivity(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.formH3:
                ...
                break;
            case R.id.formH4:
                oF = new Intent(this, SectionH5Activity.class);
                break;
            case R.id.formCHC:
                oF = new Intent(this, SectionIM1Activity.class);
                break;
            case R.id.formCHD:
                oF = new Intent(this, SectionIM2Activity.class);
                break;
            case R.id.formCHE:
                oF = new Intent(this, SectionIM3Activity.class);
                break;
